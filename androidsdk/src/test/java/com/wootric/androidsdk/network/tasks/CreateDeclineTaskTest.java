...
public class CreateDeclineTaskTest {
    ...
    public void testGet_RequestWithEuToken() throws Exception {
        CreateDeclineTask asyncTask = new CreateDeclineTask(END_USER_ID, USER_ID, ACCOUNT_ID, PRIORITY,ORIGIN_URL, ACCESS_TOKEN, "EU-NPS", offlineDataHandler, UNIQUE_LINK);
