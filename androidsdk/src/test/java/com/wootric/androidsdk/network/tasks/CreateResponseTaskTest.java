...
public class CreateResponseTaskTest {
    ...
    public void testGet_RequestWithEuToken() throws Exception {
        CreateResponseTask asyncTask = new CreateResponseTask(END_USER_ID, USER_ID, ACCOUNT_ID, ORIGIN_URL, SCORE, PRIORITY, TEXT, ACCESS_TOKEN, "EU-NPS", offlineDataHandler, UNIQUE_LINK);
